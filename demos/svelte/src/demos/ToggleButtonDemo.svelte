<script lang="ts">
  ...
  function handleNotificationToggle(pressed: boolean) {
    notification = pressed;
  }

  function handleDarkModeToggle(pressed: boolean) {
    darkMode = pressed;
  }
</script>
...
<div class="apg-demo-container">
  <div class="apg-demo-section">
    <h1 class="apg-demo-title">Toggle Button Demo (Svelte)</h1>
    ...
    <div
      class="mt-6 p-4 bg-blue-50 rounded-lg dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800"
    >
      ...
      <p class="text-blue-800 dark:text-blue-200">
        📧 Notifications: <strong
          >{notification ? "Enabled" : "Disabled"}</strong
        >
      </p>
      <p class="text-blue-800 dark:text-blue-200">
    ...
    <div
      class="mt-6 p-4 bg-green-50 rounded-lg dark:bg-green-900/20 border border-green-200 dark:border-green-800"
    >
      ...
      <ul class="text-green-800 dark:text-green-200 space-y-1 text-sm">
        <li>
          • Uses <code class="bg-green-100 dark:bg-green-800 px-1 rounded"
            >aria-pressed</code
          > attribute
        </li>
