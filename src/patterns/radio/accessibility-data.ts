  ...
  testing: {
    ...
    commands: [
      ...
      },
      {
        ...
        command: 'npm run test:e2e:pattern --pattern=radio',
      },
      {
        comment: {
        ...
        command: 'npm run test:e2e:react:pattern --pattern=radio',
      },
    ],
    tools: [
      {
...
test('has correct ARIA structure', async ({ page }) => {
  await page.goto('patterns/radio/react/');
