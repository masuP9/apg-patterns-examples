/**
 * Visual Cell Spanning Tests for Table Component (Vue)
 *
...
import Table, { type TableColumn, type TableRow } from './Table.vue';
...
describe('Table Visual Cell Spanning (Vue)', () => {
