...
const expandedIds = ref<string[]>(['docs']);
  ...
  <div class="apg-treegrid-demo">
    <div class="apg-treegrid-demo__description">
      <p>
        ...
        expands collapsed rows and ArrowLeft collapses expanded rows. Press Space to select/deselect
        rows. Press Enter to activate a cell.
      </p>
    </div>

    <div class="apg-treegrid-demo__controls">
      <label class="flex items-center gap-2">
        <input type="checkbox" v-model="multiselectable" />
        Multi-select mode
      </label>
    </div>
    ...
    <div v-if="selectedRowIds.length > 0" class="apg-treegrid-demo__selection-info">
