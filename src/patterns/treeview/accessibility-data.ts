...
export const treeViewAccessibilityData: PatternAccessibilityData = {
  ...
  roles: [
    ...
    },
    {
      name: 'treeitem',
      element: {
        en: 'Each node (<code>&lt;li&gt;</code>)',
        ja: '各ノード（<code>&lt;li&gt;</code>）',
      },
      description: {
    ...
    },
    {
      name: 'group',
      element: {
        en: 'Child container (<code>&lt;ul&gt;</code>)',
        ja: '子コンテナ（<code>&lt;ul&gt;</code>）',
      },
      description: {
  ...
  testing: {
    ...
    e2eTestFile: 'e2e/treeview.spec.ts',
    commands: [
      {
      ...
      },
      {
        ...
        command: 'npm run test:e2e:pattern --pattern=treeview',
      },
      {
        comment: {
        ...
        command: 'npm run test:e2e:react:pattern --pattern=treeview',
      },
    ],
    tools: [
      {
...
test('has correct ARIA structure', async ({ page }) => {
  await page.goto('patterns/treeview/react/');
