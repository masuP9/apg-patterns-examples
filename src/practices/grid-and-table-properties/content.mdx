...
<CodeFigure
  code={`<div role="grid" aria-rowcount="1000" aria-colcount="5">
  <div role="row" aria-rowindex="10">
    <div role="gridcell" aria-colindex="1">...</div>
  </div>
</div>`}
  lang="html"
  caption="Only rows 10–20 are rendered in the DOM. aria-rowcount and aria-rowindex communicate the full data set size and position to screen readers."
/>
...
<CodeFigure
  ...
  lang="html"
  caption="th with scope=&quot;col&quot; implicitly receives the columnheader role, th with scope=&quot;row&quot; receives rowheader, and td receives cell."
/>
...
<CodeFigure
  code={`<div role="gridcell" aria-readonly="true">Fixed value</div>`}
  lang="html"
  caption="Read-only cell — value cannot be edited."
/>

<CodeFigure
  code={`<div role="gridcell" aria-disabled="true">Unavailable</div>`}
  lang="html"
  caption="Disabled cell — interaction is not available."
/>
...
<CodeFigure
  code={`<div role="row">...</div>`}
  lang="html"
  caption="Bad: No position information — screen readers cannot determine where this row is in the data set."
/>

<CodeFigure
  code={`<div role="row" aria-rowindex="50">...</div>`}
  lang="html"
  caption="Good: Clear position — screen readers can announce &quot;row 50&quot;."
/>
...
<CodeFigure
  code={`<th>Name</th>`}
  lang="html"
  caption="Bad: Missing scope — screen readers may not correctly associate the header with its column or row."
/>
...
<th scope="row">John</th>`}
  lang="html"
  caption="Good: Explicit scope clarifies the header's direction (column or row)."
/>
