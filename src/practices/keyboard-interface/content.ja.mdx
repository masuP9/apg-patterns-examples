...
<div role="toolbar" aria-label="書式設定" focusgroup="horizontal">
  <button>太字</button>
  <button>斜体</button>
  <button>下線</button>
</div>`}
...
<ul role="menu" focusgroup="vertical">
  <li role="menuitem" tabindex="0">ファイル</li>
  <li role="menuitem" tabindex="-1">編集</li>
  <li role="menuitem" tabindex="-1">表示</li>
</ul>

<!-- 2Dグリッドナビゲーション（絵文字ピッカー、カレンダーなど） -->
