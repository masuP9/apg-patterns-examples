...
<CodeFigure
  ...
  lang="html"
  caption="Bad: aria-label on non-interactive element — paragraphs are not named by aria-label in the accessible name computation."
/>

<CodeFigure
  code={`<p>This is a paragraph</p>`}
  lang="html"
  caption="Good: Let the text content serve as the accessible content for paragraphs."
/>
