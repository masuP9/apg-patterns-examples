...
| Concept                    | Purpose                                   | Announced When                | Examples                                           |
| -------------------------- | ----------------------------------------- | ----------------------------- | -------------------------------------------------- |
| **Accessible Name**        | Primary label that identifies the element | Focus, interaction            | "Submit", "Close dialog", "Email input"            |
| **Accessible Description** | Additional context or instructions        | After the name (configurable) | "Required field", "Password must be 8+ characters" |
